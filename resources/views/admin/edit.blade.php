                        ...
                        <div class="form__input_block form__input_block-admin">
                            ...
                            <div class="col-sm-7">
                                <div class="form__input_position form-group{{ $errors->has('password') ? ' has-danger' : '' }}">
                                    <input class="form__input_indent form__input form-control{{ $errors->has('password') ? ' is-invalid' : '' }}" name="password" type="password" id="input-password" placeholder="" value="111111" required />
